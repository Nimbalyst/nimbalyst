 ...
 */
export const AI_PROVIDER_TYPES = ['claude', 'claude-code', 'openai', 'openai-codex', 'lmstudio', 'opencode', 'copilot-cli'] as const;
...
export function isAgentProvider(provider: string | null | undefined): provider is 'claude-code' | 'openai-codex' | 'opencode' | 'copilot-cli' {
  return provider === 'claude-code' || provider === 'openai-codex' || provider === 'opencode' || provider === 'copilot-cli';
}
