/**
 * Audio playback utility for Mobile Voice Mode
 *
 * Plays back PCM16 audio received from OpenAI Realtime API.
 * This is a port of the desktop AudioPlayback class for mobile use.
 */
...
export class AudioPlayback {
  ...
  constructor() {
    // Create audio context with 24kHz sample rate to match OpenAI output
  ...
  /**
   * Stop all audio playback (e.g., when user interrupts)
   */
  stop(): void {
