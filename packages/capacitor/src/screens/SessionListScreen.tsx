...
export function SessionListScreen() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Header */}
      <header className="flex items-center justify-between px-4 py-3 border-b border-[var(--border-primary)] bg-[var(--surface-secondary)]">
        <div className="flex items-center gap-2">
          {/* Project Picker Button */}
          <button
            onClick={() => setShowProjectPicker(true)}
            className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-[var(--surface-tertiary)] text-[var(--text-primary)]"
          >
