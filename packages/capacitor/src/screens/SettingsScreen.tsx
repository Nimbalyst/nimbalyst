      ...
      <main className="flex-1 p-4">
        ...
        {needsLogin && (
          <div className="mb-6">
            ...
            <div className="mb-4 p-4 rounded-lg bg-green-500/10 border border-green-500/30 flex items-center gap-3">
                  ...
                  {credentials?.syncEmail && (
                    <div className="mb-4 p-4 rounded-lg bg-[var(--surface-tertiary)] border border-[var(--border-primary)]">
                      ...
                      <div className="flex items-start gap-2 text-xs text-amber-500">
                        ...
                        <span>Must match your desktop account for sync to work</span>
                      </div>
                    </div>
                  )}
        ...
        <div className="mt-8 p-4 rounded-lg bg-[var(--surface-secondary)] border border-[var(--border-primary)]">
          ...
          <ol className="text-xs text-[var(--text-secondary)] space-y-2 list-decimal list-inside mb-4">
            ...
            <li>Sign in with the same account as desktop</li>
          </ol>
          <div className="p-3 rounded-lg bg-amber-500/10 border border-amber-500/20">
            <div className="flex items-start gap-2 text-xs text-amber-500">
              ...
              <span>You must use the same account on both devices for sync to work. The QR code securely transfers your encryption key.</span>
            </div>
          </div>
        </div>
