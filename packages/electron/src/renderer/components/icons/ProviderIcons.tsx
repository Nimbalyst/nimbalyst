...
// Anthropic/Claude logo - from LobeHub icons
...
// OpenAI logo - simplified version
...
// LMStudio logo - from LobeHub icons
export const LMStudioIcon: React.FC<IconProps> = ({ size = 20, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const GenericAIIcon: React.FC<IconProps> = ({ size = 20, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
