...
const DiscordLogo = () => (
  <svg className="w-12 h-auto" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    >
      ...
      >
        ...
        <div className="px-8 pt-12 pb-8 text-center">
          <div className="mx-auto mb-6 w-20 h-20 rounded-[20px] flex items-center justify-center bg-gradient-to-br from-[#5865f2] to-[#7289da] shadow-[0_4px_16px_rgba(88,101,242,0.3)]">
            <DiscordLogo />
          </div>
          ...
          <div className="discord-invitation-buttons flex justify-center mb-5">
            ...
            >
              <svg className="w-5 h-auto text-white" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0)">
