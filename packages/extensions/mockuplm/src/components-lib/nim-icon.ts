/**
 * <nim-icon> - Icon display using inline SVG
 *
 * Attributes:
 *   name: icon name (from built-in set)
 *   size: CSS size (default: "16px")
 *   color: CSS color (default: "currentColor")
 *
 * Usage:
 *   <nim-icon name="settings" />
 *   <nim-icon name="check" size="20px" color="var(--mockup-success)" />
 */
export const NIM_ICON_SRC = `
class NimIcon extends HTMLElement {
  ...
  render() {
    ...
    this.shadowRoot.innerHTML = \`
      ...
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">\${svg}</svg>
    \`;
  }
}
customElements.define('nim-icon', NimIcon);
`;
