...
/**
 * Built-in crystal dark theme colors.
 */
const crystalDarkThemeColors: ExtendedThemeColors = {
  // Backgrounds
  'bg': '#0f172a',
  'bg-secondary': '#020617',
  'bg-tertiary': '#1e293b',
  ...
  'toolbar-active': 'rgba(37, 99, 235, 0.2)',
  ...
  // Syntax highlighting
  'code-comment': '#9CA3AF',
  'code-punctuation': '#D1D5DB',
  'code-property': '#60A5FA',
  'code-selector': '#FDE047',
...
const builtInThemes: Theme[] = [
  ...
  { id: 'crystal-dark', name: 'Crystal Dark', isDark: true, colors: crystalDarkThemeColors },
];
