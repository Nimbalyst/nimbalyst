...
| `ai_message_queued` | `AIService.ts:2483, 640` | User queues message while AI is busy processing | `provider`<br/>`source` (local/mobile)<br/>`hasDocumentContext`<br/>`hasAttachments` | (pending release as of f891af91) |  |
