...
3. **Get changelogs** for both packages:
  - For claude-agent-sdk: Fetch https://github.com/anthropics/claude-code/releases to find changes between current and latest
...
4. **Report the changes** - Show what changed between the current version and latest for each library
